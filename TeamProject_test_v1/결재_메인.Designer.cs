namespace TeamProject_test_v1
{
    partial class 결재_메인
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabControl1.Size = new Size(1270, 709);
            tabControl1.TabIndex = 0;
            // 
            // tabPage1
            // 
            tabPage1.Controls.Add(결재_조회_상세정보창);
            ...
            tabPage1.Size = new Size(1262, 676);
            tabPage1.TabIndex = 0;
            tabPage1.Text = "결재 조회";
            ...
            // 결재_조회_상세정보창
            // 
            결재_조회_상세정보창.Location = new Point(653, 55);
            결재_조회_상세정보창.Margin = new Padding(4, 5, 4, 5);
            결재_조회_상세정보창.Name = "결재_조회_상세정보창";
            결재_조회_상세정보창.Size = new Size(599, 335);
            결재_조회_상세정보창.TabIndex = 56;
            // 
            // 초기화_버튼
            // 
            초기화_버튼.Font = new Font("굴림", 13F, FontStyle.Regular, GraphicsUnit.Point);
            초기화_버튼.Location = new Point(984, 388);
            초기화_버튼.Margin = new Padding(4, 5, 4, 5);
            초기화_버튼.Name = "초기화_버튼";
            초기화_버튼.Size = new Size(126, 35);
            초기화_버튼.TabIndex = 55;
            초기화_버튼.Text = "초기화";
            ...
            결재_등록_내역_리스트_콤보박스.Location = new Point(825, 21);
            ...
            조회_2단계_결재자_코맨트_텍스트박스.Size = new Size(378, 111);
            ...
            label8.Location = new Point(831, 81);
            ...
            조회_단계1_결재자_코맨트_텍스트박스.Size = new Size(378, 111);
            ...
            등록_결재_상세정보_텍스트박스.Size = new Size(378, 111);
            ...
            label2.Location = new Point(336, 11);
            ...
            label3.Location = new Point(653, 11);
            ...
            label4.Location = new Point(957, 11);
            ...
            관련_업무_콤보박스.Location = new Point(336, 41);
            ...
            불러오기_버튼.Location = new Point(1014, 19);
            불러오기_버튼.Margin = new Padding(4, 5, 4, 5);
            불러오기_버튼.Name = "불러오기_버튼";
            불러오기_버튼.Size = new Size(111, 33);
            불러오기_버튼.TabIndex = 32;
            불러오기_버튼.Text = "불러오기";
            ...
            // 결재_등록_내역_그리드뷰
            // 
            결재_등록_내역_그리드뷰.AllowUserToDeleteRows = false;
            결재_등록_내역_그리드뷰.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            결재_등록_내역_그리드뷰.Location = new Point(17, 59);
            결재_등록_내역_그리드뷰.Margin = new Padding(4, 5, 4, 5);
            결재_등록_내역_그리드뷰.Name = "결재_등록_내역_그리드뷰";
            결재_등록_내역_그리드뷰.ReadOnly = true;
            결재_등록_내역_그리드뷰.RowHeadersVisible = false;
            결재_등록_내역_그리드뷰.RowHeadersWidth = 51;
            결재_등록_내역_그리드뷰.RowTemplate.Height = 23;
            결재_등록_내역_그리드뷰.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            결재_등록_내역_그리드뷰.Size = new Size(600, 323);
            ...
            등록_버튼.Location = new Point(1117, 388);
            등록_버튼.Margin = new Padding(4, 5, 4, 5);
            등록_버튼.Name = "등록_버튼";
            등록_버튼.Size = new Size(126, 35);
            등록_버튼.TabIndex = 17;
            등록_버튼.Text = "등록";
            ...
            // tabPage2
            // 
            tabPage2.Controls.Add(승인_반려_상세정보창);
            ...
            tabPage2.Size = new Size(1262, 676);
            tabPage2.TabIndex = 1;
            ...
            // 승인_반려_상세정보창
            // 
            승인_반려_상세정보창.Location = new Point(653, 51);
            승인_반려_상세정보창.Margin = new Padding(4, 5, 4, 5);
            승인_반려_상세정보창.Name = "승인_반려_상세정보창";
            승인_반려_상세정보창.Size = new Size(590, 337);
            승인_반려_상세정보창.TabIndex = 55;
            // 
            // 승인_반려_불러오기_버튼
            // 
            승인_반려_불러오기_버튼.Font = new Font("굴림", 13F, FontStyle.Regular, GraphicsUnit.Point);
            승인_반려_불러오기_버튼.Location = new Point(1119, 13);
            승인_반려_불러오기_버튼.Margin = new Padding(4, 5, 4, 5);
            승인_반려_불러오기_버튼.Name = "승인_반려_불러오기_버튼";
            승인_반려_불러오기_버튼.Size = new Size(125, 33);
            ...
            승인_반려_2단계_결재자_코맨트_텍스트박스.Size = new Size(378, 111);
            ...
            label9.Location = new Point(831, 81);
            ...
            승인_반려_1단계_결재자_코맨트_텍스트박스.Size = new Size(378, 111);
            ...
            관련_업무.Location = new Point(336, 11);
            ...
            결재자1.Location = new Point(652, 11);
            ...
            결재자2.Location = new Point(957, 11);
            ...
            결재리스트_선택_콤보박스.Size = new Size(199, 30);
            ...
            // 결재해야할_내역_그리드뷰
            // 
            결재해야할_내역_그리드뷰.AllowUserToDeleteRows = false;
            결재해야할_내역_그리드뷰.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            결재해야할_내역_그리드뷰.Location = new Point(15, 55);
            결재해야할_내역_그리드뷰.Margin = new Padding(4, 5, 4, 5);
            결재해야할_내역_그리드뷰.Name = "결재해야할_내역_그리드뷰";
            결재해야할_내역_그리드뷰.ReadOnly = true;
            결재해야할_내역_그리드뷰.RowHeadersVisible = false;
            결재해야할_내역_그리드뷰.RowHeadersWidth = 51;
            결재해야할_내역_그리드뷰.RowTemplate.Height = 23;
            결재해야할_내역_그리드뷰.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            결재해야할_내역_그리드뷰.Size = new Size(600, 323);
            ...
            승인_버튼.Location = new Point(1018, 389);
            ...
            반려_버튼.Location = new Point(1137, 389);
            ...
            결재_해야할_리스트.Location = new Point(15, 17);
