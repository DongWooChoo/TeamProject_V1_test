...
namespace TeamProject_test_v1
{
    public partial class 부서목록 : Form
    {
        ...
        private void operate_button_click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Rows[seletcting_].Selected = true;
        }
        private void adder()
        {
            DataTable dt = new DataTable();
        ...
        private void newmember_click()
        {
            ...
            Regex regex = new Regex(@"^[ㄱ-ㅎ가-힣a-zA-Z]+\([0-9]{8}\)$");
            ...
            if (checking == 1)
            {
                ...
                if (newmember_textBox.Text != "신규인원")
                {
                ...
                member_combobox.SelectedIndex = -1;
            }
        ...
        private void editer_click()
        {
            ...
            if (at.Rows[0][2].ToString() != null)
            {
                this.query = $"update s5584720.사원 set 부서번호=NULL,부서명=NULL,직급번호=NULL, 직급=NULL where 사원번호='{old_split[1]}'";//기존사원직급,직책 변경
                DBManager.GetDBManager().SetQuery(this.query).ExecuteNonQuery();
            }
            ...
            editmember_combobox.SelectedIndex = -1;
        ...
        private void deleteer()
        {
            ...
            string query_1 = $"delete from s5584720.부서 where 부서코드={Convert.ToInt32(dataGridView1.Rows[dataGridView1.SelectedCells[0].RowIndex].Cells[0].Value.ToString())}";
            string query_2 = $"update s5584720.사원 set 부서명=NULL, 부서코드=NULL where 부서코드={Convert.ToInt32(dataGridView1.Rows[dataGridView1.SelectedCells[0].RowIndex].Cells[0].Value.ToString())}";
