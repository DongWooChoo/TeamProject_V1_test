...
namespace TeamProject_test_v1
{
    internal class 추가수당
    {
        ...
        public void moneyTable(string num)
        {
            ...
            string query = "INSERT INTO `s5584720`.`급여내역` (`사원번호`, `기본급`, `야간근로수당`, `연장근로수당`, `휴일근로수당`, `국민연금`, `국민건강보험`, `장기요양국민건강보험`, `고용보험료`, `실수령액`, `지급날짜`) VALUES ('@num', '@money', '@night', '@longWork', '@holiy', '@NP', '@NHI', '@LCNHI', '@EIP', '@total', '@month-10 00:00:00');";
            query = query.Replace("@num", num);
