...
namespace TeamProject_test_v1
{
    public partial class 출퇴근현황 : Form
    {
        ...
        {
            string query = "SELECT s5584720.사원.이름, s5584720.출근부.출근시간, s5584720.출근부.퇴근시간 FROM s5584720.출근부 INNER JOIN s5584720.사원 ON s5584720.출근부.사원번호 = s5584720.사원.사원번호 WHERE s5584720.출근부.사원번호 = '@num';";
